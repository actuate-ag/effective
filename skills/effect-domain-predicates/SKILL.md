...
description: Generate predicates, refinements, and Order instances for Effect domain types. Use this skill when adding equality, comparison, or guard helpers to a Schema-defined type, or when producing the predicate/order surface for an ADT.
---
