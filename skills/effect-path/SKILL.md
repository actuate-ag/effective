---
name: effect-path
description: Manipulate file paths cross-platform with Effect's Path service. Use this skill when joining, resolving, or normalizing paths, converting between path strings and URLs, or replacing direct node:path imports in Effect code.
---
