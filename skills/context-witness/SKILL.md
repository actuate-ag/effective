...
description: Choose between the Context.Service witness pattern and capability-style dependency injection in Effect. Use this skill when defining a new service tag, deciding whether to expose a single Service or a set of capabilities, or refactoring services to reduce coupling.
---
