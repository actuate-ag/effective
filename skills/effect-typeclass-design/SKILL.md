...
description: Design Effect typeclass-style modules with dual data-first and data-last APIs. Use this skill when adding a new combinator that should work both pipeable (data-last) and direct-call (data-first), or when curating function signatures for ergonomic Effect APIs.
---
