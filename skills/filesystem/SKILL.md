---
name: filesystem
description: Read, write, and manipulate files via Effect's FileSystem service across Node.js, Bun, and browser. Use this skill when reaching for fs / fs/promises, performing scoped temp-file work, streaming file contents, or writing portable file I/O in Effect code.
---
