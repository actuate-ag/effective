...
description: Structure platform-layer provisioning for cross-platform Effect applications. Use this skill when wiring @effect/platform-node or @effect/platform-bun layers, deciding where the platform boundary lives, or keeping domain code free of platform-specific imports.
---
